...
client.publish("home-assistant/pump/1/state", "OFF")
client.publish("home-assistant/pump/2/state", "OFF")
client.publish("home-assistant/pump/3/state", "OFF")
client.publish("home-assistant/pump/4/state", "OFF")
